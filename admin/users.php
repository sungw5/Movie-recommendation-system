              ...
              <table id="myTable" class="table table-hover">
                ...
                <?php while($row = $result->fetch_assoc()): ?>
                  ...
                  <tr>
                    ...
                    <!-- edit,delete button -->
                      <!-- <td>
                        <a href="users.php?edit=<?php echo $row['user_id']; ?>" class="btn btn-info">Edit</a>
                        <a href="users_function.php?delete=<?php echo $row['user_id']; ?>" class="btn btn-danger">Delete</a>
                      </td> -->
                  </tr>
